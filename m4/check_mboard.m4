# $Id: check_mboard.m4 1046 2008-07-13 12:49:44Z lsc $
# 
...
MBOARD_S_CFLAGS=""
MBOARD_P_CFLAGS="${MB_PARALLEL_CFLAGS}"
MBOARD_SD_CFLAGS=""
MBOARD_PD_CFLAGS="${MB_PARALLEL_CFLAGS}"

MBOARD_S_LIBS="-lmboard_s"
MBOARD_P_LIBS="-lmboard_p ${MB_PARALLEL_LIBS}"
MBOARD_SD_LIBS="-lmboard_sd"
MBOARD_PD_LIBS="-lmboard_pd ${MB_PARALLEL_LIBS}"

MBOARD_S_LDFLAGS=""
MBOARD_P_LDFLAGS="${MB_PARALLEL_LDFLAGS}"
MBOARD_SD_LDFLAGS=""
MBOARD_PD_LDFLAGS="${MB_PARALLEL_LDFLAGS}"
