...
MBOARD_P_LIBS="-lmboard_p"
MBOARD_SD_LIBS="-lmboard_sd"
MBOARD_PD_LIBS="-lmboard_pd"
MBOARD_S_LDFLAGS=""
MBOARD_P_LDFLAGS=""
MBOARD_SD_LDFLAGS=""
MBOARD_PD_LDFLAGS=""
...
then
	...
	MBOARD_CFLAGS="${CFLAGS} ${MBOARD_CFLAGS}"
...
CFLAGS="${MPICFLAGS} ${THREADS_CFLAGS} ${CFLAGS}"
LDFLAGS="${MPILIBS} ${LDFLAGS}"
LIBS="${MPILIBS} ${THREADS_LIBS} ${LIBS}"
