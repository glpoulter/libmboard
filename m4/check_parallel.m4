# $Id: check_parallel.m4 1386 2008-12-03 11:34:38Z lsc $
# 
 ...
 ** Or, if you do not need the parallel libraries, reconfigure with the
	...
	THREADS_LDFLAGS="${PTHREAD_LDFLAGS} " 
	
	MB_PARALLEL_CFLAGS="${MPICFLAGS} ${THREADS_CFLAGS} ${MB_EXTRA_CFLAGS}"
	MB_PARALLEL_LDFLAGS="${MPILDFLAGS} ${THREADS_LDFLAGS} ${MB_EXTRA_LDFLAGS}"
	MB_PARALLEL_LIBS="${MPILIBS} ${THREADS_LIBS} ${MB_EXTRA_LIBS}"
