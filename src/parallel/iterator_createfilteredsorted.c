/* $Id: iterator_createfilteredsorted.c 2108 2009-09-14 14:14:31Z lsc $ */
/*!
 * \file parallel/iterator_createfilteredsorted.c
 * \code
 ...
 * \endcode
 * 
 * \brief Parallel implementation of MB_Iterator_CreateFilteredSorted()
 * 
 */
...
int MB_Iterator_CreateFilteredSorted(MBt_Board mb, MBt_Iterator *itr_ptr, \
    ...
    *itr_ptr  = (MBt_Iterator)rc_om;
    ...
    P_INFO("Iterator created (iter:%d, board:%d, mcount:%d) - FITLERED+SORTED", 
