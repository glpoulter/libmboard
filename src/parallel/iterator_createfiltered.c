/* $Id: iterator_createfiltered.c 2176 2009-10-01 10:58:55Z lsc $ */
/*!
 * \file parallel/iterator_createfiltered.c
 * \code
 ...
 * \endcode
 * 
 * \brief Parallel implementation of MB_Iterator_CreateFiltered()
 * 
 */
