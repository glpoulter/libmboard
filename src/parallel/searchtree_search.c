/* $Id: searchtree_search.c 2948 2012-10-09 15:51:40Z lsc $ */
/*!
 * \file parallel/searchtree_search.c
 * \code
 *      Author: Shawn Chin
 *      Date  : July 2012
 ...
 * \endcode
 *
 * \brief Parallel implementation of MB_SearchTree_Search*
 *
 */
 ...
 * \param[in] tree Reference to the 3D tree object
 * \param[in] itr_ptr Reference to pooled_list object where results will be appended to
 * \param[in] ndims Number of dimensions
 * \param[in] dim_boundaries Array of dimension boundaries
 *
