/* $Id: test_mb_p_iterator_createfilteredsorted.c 2925 2012-07-20 14:12:17Z lsc $ */
/* 
...
#define TEST_FILTER_UB (int)(PARALLEL_TEST_MSG_COUNT * 0.75)
#define TEST_FILTER_LB (int)(PARALLEL_TEST_MSG_COUNT * 0.25)
